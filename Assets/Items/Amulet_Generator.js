...
public static class Amulet_Generator
{
	var roll_1 : int;
	var roll_3 : int;
	...
	function Generate() : Amulet
	{
		...
		var random_amulet : Amulet = new Amulet(name, damage, speed, defense, magic, price);
		
		return random_amulet;
	}
	...
	function Generate_Specific(prefix : int, quality : int) : Amulet
	{
		...
		var specific_amulet : Amulet = new Amulet(name, damage, speed, defense, magic, price);
		
		return specific_amulet;
	}
	...
	private function Amulet_Type(quality_roll : int) : String
	{
		var type : String;
		
		switch(quality_roll)
		{
			case 0: type = "Necklace";
				break;
			case 1: type = "Trinket";
				break;
			case 2: type = "Rabbit's Foot";
				break;
			case 3: type = "Charm";
				break;
			case 4: type = "Amulet";
				break;
			case 5: type = "Talisman";
				break;
		}
		return type;
	}
